...
Implements the **SD-JWT VC** profile from **[I2H2A v0.2](https://github.com/i2h2a-org/I2H2A-spec/blob/main/I2H2A-v0.2-draft.md)** (RFC 9901, ES256/P-256, KB-JWT holder binding). For protocol narratives, see **[I2H2A-v0.3.1-draft.md](https://github.com/i2h2a-org/I2H2A-spec/blob/main/I2H2A-v0.3.1-draft.md)** (current) and **[v0.3 snapshot](https://github.com/i2h2a-org/I2H2A-spec/blob/main/I2H2A-v0.3-draft.md)**.
